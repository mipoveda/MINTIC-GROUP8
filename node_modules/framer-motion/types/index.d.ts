...
export { useInvertedScale } from "framer-motion/types/value/use-inverted-scale";
...
export { HoverHandlers, TapHandlers, PanHandlers, TapInfo, PanInfo, useTapGesture, usePanGesture, useGestures, } from "framer-motion/types/gestures";
...
export { useAnimatedState } from "framer-motion/types/animation/use-animated-state";
export { addScaleCorrection } from "framer-motion/types/render/dom/layout/scale-correction";
export { startAnimation } from "framer-motion/types/animation/utils/transitions";
export { startVisualElementAnimation } from "framer-motion/types/render/VisualElement/utils/animation";
/**
 * Contexts
 */
...
export { GestureHandlers } from "framer-motion/types/gestures";
